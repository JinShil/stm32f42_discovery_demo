...
* I have to put a `.value` every time I want to access a memory-mapped IO bitfield.  This is because of a [bug in `static alias x this;`](https://issues.dlang.org/show_bug.cgi?id=17684).  I think if I were to do this again, I would use a different pattern altogether.
